...
def test_7_success_rate():
    ...
    save_call_analytics(
        session_id="c1", outcome="successful", outcome_type="GENERAL_GUIDANCE"
    )
    save_call_analytics(
        session_id="c2", outcome="successful", outcome_type="TRIAGE_COMPLETED"
    )
    save_call_analytics(
        session_id="c3", outcome="successful", outcome_type="FACILITY_FOUND"
    )
...
def test_8_outcome_breakdown():
    ...
    save_call_analytics(
        session_id="b1", outcome="successful", outcome_type="GENERAL_GUIDANCE"
    )
    save_call_analytics(
        session_id="b2", outcome="successful", outcome_type="GENERAL_GUIDANCE"
    )
    save_call_analytics(
        session_id="b3", outcome="successful", outcome_type="TRIAGE_COMPLETED"
    )
    save_call_analytics(
        session_id="b4", outcome="successful", outcome_type="FACILITY_FOUND"
    )
    save_call_analytics(
        session_id="b5", outcome="successful", outcome_type="HUMAN_ESCALATION"
    )
