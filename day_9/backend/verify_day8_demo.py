...
def main():
    ...
    print(
        f"Initial metrics: Total={initial_total}, Successful={initial_succ}, Failed={initial_failed}"
    )
    ...
    print(
        f"Total Calls: {updated['total_calls']} (increased by {updated['total_calls'] - initial_total})"
    )
    print(
        f"Successful Calls: {updated['successful_calls']} (increased by {updated['successful_calls'] - initial_succ})"
    )
    print(
        f"Failed Calls: {updated['failed_calls']} (increased by {updated['failed_calls'] - initial_failed})"
    )
