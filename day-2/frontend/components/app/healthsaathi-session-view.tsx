...
export function HealthSaathiSessionView() {
  ...
  return (
    <div className="flex min-h-screen select-none flex-col justify-between bg-[#F8FAFC] font-sans text-slate-900">
      {/* Top Header Bar */}
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span
                className={`rounded-full border text-[10px] font-bold tracking-wider uppercase px-2 py-0.5 ${getStatusBadgeColor()}`}
              >
                {currentStatus}
              </span>
            </div>
      ...
      <main className="mx-auto flex w-full max-w-4xl flex-1 flex-col justify-between gap-6 px-4 py-6 sm:px-6">
        ...
        <div className="relative flex min-h-[260px] flex-1 flex-col items-center justify-center">
          ...
          <div className="relative flex size-64 items-center justify-center sm:size-72">
            ...
            >
              <div className="flex size-full flex-col items-center justify-center overflow-hidden rounded-full bg-slate-900/90 p-4 text-white backdrop-blur-md">
                <Heart
        ...
        {showTranscript && (
          <div className="flex max-h-[240px] flex-col gap-3 rounded-3xl border border-slate-200/80 bg-white p-5 shadow-sm">
            ...
            <div
              ref={scrollAreaRef}
              className="scrollbar-thin scrollbar-thumb-slate-200 flex-1 overflow-y-auto pr-2 space-y-3"
            >
              {messages.length === 0 ? (
